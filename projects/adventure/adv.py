...
# roomGraph={0: [(3, 5), {'n': 1}], 1: [(3, 6), {'s': 0, 'n': 2, 'e': 3}], 2: [(3, 7), {'s': 1}], 3: [(4, 6), {'w': 1, 'n': 4}], 4: [(4,7), {'s': 3}]}
...
# print("dirs", player.currentRoom.getExits())
# player.travel("w")
# print("id", player.currentRoom.id)
# print("dirs", player.currentRoom.getExits())
player.currentRoom.printRoomDescription(player)

# possible_dirs = ["n", "w", "s", "e"]
# # print('graph 000', roomGraph[0][1])
# # print('graph 001', roomGraph[1][1])
# # print('graph 002', roomGraph[2][1])
# # print('graph 003', roomGraph[3][1])

# def opposite_of(dir):
#     if dir is "n": return "s"
#     elif dir is "e": return "w"
#     elif dir is "s": return "n"
#     elif dir is "w": return "e"
# last_move = "w"
# opposite = ""
# traversal = []
# # path = []
...
#     current = stack.pop()
#     # print("cur:", current[0])
#     # print("cur nbrs", roomGraph[current[0]][1])
#     # print("path:", path)
#     if len(current[1]) > 0: last_move = current[1][-1]
#     visited_rooms[current[0]] = current[1]
#     print("curr", current[0])
#     # print("path", current[1])
#     for direction in roomGraph[current[0]][1]:
#         # print("dir", direction)
#         # print("opp", opposite_of(last_move))
#         if direction is "n" and direction is not opposite_of(last_move):
#             # print('graph', roomGraph[current[0]][1]['n'])
#             path = current[1].copy()
#             path.append("n")
#             stack.push((roomGraph[current[0]][1]['n'], path))
#         elif direction is "s" and direction is not opposite_of(last_move):
#             path = current[1].copy()
#             path.append("s")
#             stack.push((roomGraph[current[0]][1]['s'], path))
#         elif direction is "e" and direction is not opposite_of(last_move):
#             path = current[1].copy()
#             path.append("e")
#             stack.push((roomGraph[current[0]][1]['e'], path))
#         elif direction is "w" and direction is not opposite_of(last_move):
#             path = current[1].copy()
#             path.append("w")
#             stack.push((roomGraph[current[0]][1]['w'], path))
#         # else:
#         #     for i in current[1]:
#         #         print("i", i)

#     if current[0] == world.startingRoom.id:
#         pass 
#         # return traversal

# print(visited_rooms)
# # while len(visited_rooms) > 0:
# print("o")
# longest = visited_rooms[0]
# for i in visited_rooms:
#     # print("room:", i, "| path:", visited_rooms[i])
#     if len(visited_rooms[i]) > len(longest):
#         longest = visited_rooms[i]
# next_longest = visited_rooms[0]
# for i in visited_rooms:
#     if len(visited_rooms[i]) > len(next_longest) and len(visited_rooms[i]) <= len(longest):
#         next_longest = visited_rooms[i]

# different = -1  #???? maybe last not first
# for i in range(len(next_longest)):
#     if next_longest[i] != longest[i]:
#         different = i
# if different == -1:
#     pass
# print("l nl", longest, next_longest)


# visited_rooms[2] = visited_rooms[2] + visited_rooms[0]
# print(visited_rooms[2])

def green_east():
    arr = []
    # upper branch (20 and beyond)
    arr.append('n')
    arr.append('n')
    arr.append('n')
    arr.append('n')
...
def northwest_orange():
    arr = []
    #  north branch 61 and beyond
    arr.append('n')
    arr.append('n')
    arr.append('n')
    arr.append('w')
...
def north_loop():
    ...
    arr.append('e') 
    arr.append('e') 
    # rest of loop after west branch
    arr.append('e') 
    arr.append('n')
    arr.append('n') 
    arr.append('s') 
    ...
    return arr
#go left to green branch (12 and beyond)
traversalPath.append('e')
traversalPath.append('n')
traversalPath.append('n')
traversalPath.append('s')
traversalPath.append('e')
traversalPath += green_east()
print(traversalPath)
#go to se pink branch (50 and beyond)
traversalPath.append('s')
traversalPath.append('e')
...
traversalPath.append('s')
traversalPath.append('s')
traversalPath += pink_southeast()
# go to small lower loop
traversalPath.append('w')
traversalPath += south_loop()
#navigate to 0 room
traversalPath.append('e')
traversalPath.append('n')
traversalPath.append('n')
...
traversalPath.append('n')
traversalPath.append('w')
traversalPath += northwest_orange()
# go to north loop and hit small orange branches along way
traversalPath.append('n')
traversalPath.append('s')
traversalPath.append('e')
traversalPath.append('s')
